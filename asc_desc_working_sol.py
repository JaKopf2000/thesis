...
def calculate_and_plot(file_path_radiation_asc, file_path_humidity_asc, file_path_radiation_desc, file_path_humidity_desc):
    ...
    ax1.set_title(f'Fnet_sol - Ascend ({start_date_asc} to {end_date_asc})')
    ax1.legend()
    ax1.grid(True)
    ax1.set_xlim(-20, 100)  # Set x-axis limits for Fnet plot
    ...
    ax2.set_title(f'Fnet_sol - Descend ({start_date_desc} to {end_date_desc})')
    ax2.legend()
    ax2.grid(True)
    ax2.set_xlim(-20, 100)  # Set x-axis limits for Fnet plot
   ...
   # ax5.set_title('Temperature and Humidity - Descend')
    ...
    plt.suptitle('Ascend and Descend Dataset 14', fontsize=16)
    plt.show()
...
def process_data(file_path_radiation):
    ...
    radiation_avg['Net Irradiance [W/m**2]'] = (radiation_avg['SWD [W/m**2] (corrected)'] - radiation_avg['SWU [W/m**2] (corrected)'])#(radiation_avg['LWD [W/m**2] (corrected)'] - radiation_avg['LWU [W/m**2] (corrected)']) #+ \
...
# Example usage
file_path_radiation_asc = '/Users/jakobdietz/Uni Leipzig/Bachelor Thesis/Gottschalk-Egerer_2021_AO2018/csv_split/6radiation_corr_ascend.csv'  # Replace with your file path for radiation data
file_path_humidity_asc =  '/Users/jakobdietz/Uni Leipzig/Bachelor Thesis/Gottschalk-Egerer_2021_AO2018/csv_split/6radiation_corr_ascend.csv'  # Replace with your file path for humidity data
file_path_radiation_desc ='/Users/jakobdietz/Uni Leipzig/Bachelor Thesis/Gottschalk-Egerer_2021_AO2018/csv_split/6radiation_corr_descend.csv'
file_path_humidity_desc = '/Users/jakobdietz/Uni Leipzig/Bachelor Thesis/Gottschalk-Egerer_2021_AO2018/csv_split/6radiation_corr_descend.csv'
